...
la logica non importata ma riconosciuta dentro F-I-E-C, fino a
osservare Curry-Howard come gesto finale (\S\ref{cap:logica}). Un kit
di costruzioni canoniche --- i \emph{tipi notevoli}
...
\section*{Patto di lettura per Parte~III e Parte~IV}
...
\noindent\textbf{(ii)} Quando la traduzione \`e \emph{meccanica} (nessun matching essenziale su $\refl$, nessun vincolo non banale sugli indici) ce lo segneremo come ``traduzione meccanica''.
...
\noindent Con questo patto in tasca, entriamo in Parte~III (logica e kit di costruzioni) e poi in Parte~IV (compendio di Stump) sapendo cosa stiamo importando e cosa no.
